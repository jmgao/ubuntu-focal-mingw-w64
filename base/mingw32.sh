# Shamelessly stolen from https://github.com/rust-embedded/cross/blob/master/docker/mingw.sh
set -x
...
main() {
    ...
    sed -i -e '/-win32/d' debian/gcc-mingw-w64-i686.postinst
    sed -i -e '/-win32/d' debian/gcc-mingw-w64-i686.prerm
    sed -i -e '/-win32/d' debian/g++-mingw-w64-i686.postinst
    sed -i -e '/-win32/d' debian/g++-mingw-w64-i686.prerm
...
EOF
    ...
    dpkg -i ../g*-mingw-w64-*.deb ../gcc-mingw-w64-base*.deb
